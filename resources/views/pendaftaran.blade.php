                ...
                <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
                    ...
                    <div data-mdb-input-init class="form-outline mb-4">
                        <input type="email" id="email" name="email" autocomplete="email"
                            value="{{ $user->email }}" class="form-control form-control-lg"
                            placeholder="Enter a valid email address" />
                        <label class="form-label" for="email">Email</label>
                    </div>
                    <div data-mdb-input-init class="form-outline mb-4">
                        <input type="date" id="tanggal" name="tanggal" autocomplete="tanggal"
                            class="form-control form-control-lg" />
                        <label class="form-label" for="tanggal">Tanggal</label>
                    </div>
                    <div data-mdb-input-init class="form-outline mb-4">
                        <input type="text" id="nama" name="nama" autocomplete="nama"
                            value="{{ $user->nama }}" class="form-control form-control-lg"
                            placeholder="Enter a valid nama address" />
                        <input type="hidden" id="id" name="id" autocomplete="id"
                            value="{{ $user->id }}" class="form-control form-control-lg"
                            placeholder="Enter a valid nama address" />
                        <label class="form-label" for="nama">Nama</label>
                    </div>
                    <div data-mdb-input-init class="form-outline mb-3">
                        <input type="text" id="keluhan" name="keluhan" autocomplete="keluhan"
                            class="form-control form-control-lg" placeholder="Enter keluhan" />
                        <label class="form-label" for="keluhan">Keluhan</label>
                    </div>
                    <div data-mdb-input-init class="form-outline mb-3">
                        <select id="treatment" class="form-select form-control form-control-lg"
                    ...
                    <div data-mdb-input-init class="form-outline mb-3">
                        <select id="dokter" class="form-select form-control form-control-lg"
                            aria-label="Default select example">
    ...
    <script>
        $(document).ready(function() {
            ...
            function CekValidasi() {
                if ($('#keluhan').val() == 0 || $('#keluhan').val() == '') {
                    alert('keluhan tidak boleh kosong');
                } else if ($('#tanggal').val() == 0 || $('#tanggal').val() == '') {
                    alert('silahkan pilih tanggal tidak boleh kosong');
                } else if ($('#treatment').val() == '') {
                    alert('silahkan pilih treatment tidak boleh kosong');
                } else {
                    var result = true;
                }
                return result;
            ...
            function inserttablehistory(dokter, keluhan, tanggal, approve) {
                var row = "";
                row =
                    '<tr>' +
                    '<td>' + dokter + '</td>' +
